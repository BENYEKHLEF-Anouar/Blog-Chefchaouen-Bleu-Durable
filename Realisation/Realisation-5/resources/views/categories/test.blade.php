...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
            <h3 class="text-xl font-bold text-gray-800 mb-6"> <i class="fas fa-newspaper mr-1"></i> {{ $category->name }}</h3>
            ...
            <p class="text-gray-600 mb-4 text-sm leading-relaxed"><i class="fas fa-newspaper mr-1"></i> {{ $category->description }}</p>
            @else
